    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
      ...
      <div class="mx-8">
        <form action="{{ route('client.produit.search') }}"
            class="relative flex w-full gap-3 flex-wrap items-stretch">
