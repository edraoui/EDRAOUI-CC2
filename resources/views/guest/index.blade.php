...
<div class="grid m-b-20 mb-8 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2">
    ...
    <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-tl-lg md:border-r dark:bg-gray-800 dark:border-gray-700">
        ...
        <figcaption class="flex items-center justify-center space-x-3">
            <img class="rounded-full w-10 h-10" src="{{ asset("storage/images/".$d->image)}}" alt="profile picture">
...
<div class="flex  items-end justify-end">
    ...
    <div class="w-40 ">
        <label for="steps-range" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Range Prix:</label>
        0<input id="steps-range" type="range" min="0" max="100" value="2.5" step="0.5" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700">Max
        </div>
</div>
@endsection
