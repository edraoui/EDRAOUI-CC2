<x-guest-layout>
    <x-auth-card>
        ...
        <a href="https://flowbite.com/" class="flex items-center text-center">
            <img src="{{asset('storage/images/12345.jpg') }}" class="h-8 mr-3" alt="Flowbite Logo" />
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Ed Shop</span>
        </a>
        </div>
